...
namespace CryptographyManager.DigitalSignatureFolder
{
    ...
    public class DigitalSignature
    {
		...
		/// 
		/// </summary>
		/// <param name="data"> a message/text to be digitally signed </param>
		...
		public static byte[] Sign(byte[] data, HashAlgorithm hashAlgorithm, X509Certificate2 certificate)
        {
